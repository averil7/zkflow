  ...
  [869],
  {
    3013: (t, e, r) => {
      ...
      let p =
        ...
        g = Array.from({ length: 256 }, (t, e) =>
          e.toString(16).padStart(2, "0"),
        );
      function y(t) {
        if ((s(t), m)) return t.toHex();
        let e = "";
      ...
      function w(t) {
        ...
        for (let e = 0, n = 0; e < r; e++, n += 2) {
          let r = v(t.charCodeAt(n)),
            o = v(t.charCodeAt(n + 1));
      ...
      function M(t) {
        return ("string" == typeof t && (t = b(t)), s(t), t);
      }
      function x(...t) {
        let e = 0;
        for (let r = 0; r < t.length; r++) {
      ...
      function _(t = 32) {
        ...
        if (i && "function" == typeof i.randomBytes)
          return Uint8Array.from(i.randomBytes(t));
    ...
    9108: (t, e, r) => {
      ...
      var i = r(49304),
        ...
        o = class extends n.b {
          ...
          constructor(t, e) {
            (super(),
              (this.socket = new window.WebSocket(t, e.protocols)),
        ...
        h = class extends n.b {
          ...
          constructor(
            ...
            (super(),
              ...
              u ? (this.dataPack = u) : (this.dataPack = new f()),
              this.autoconnect &&
                    ...
                    1e3 !== r &&
                      ...
                      (this.max_reconnects > this.current_reconnects ||
                        ...
                        : this.reconnect &&
                          ...
                          this.current_reconnects >= this.max_reconnects &&
                          setTimeout(
                            () => this.emit("max_reconnects_reached", r, i),
                            1,
                          )));
                },
              ));
        ...
        return `${t}=${(function t(e) {
          return Array.isArray(e)
            ...
            : "bigint" == typeof e
              ...
              : encodeURIComponent(
                  String(
                    null != e && null === Object.getPrototypeOf(e)
                      ? { ...e }
                      : e,
                  ),
                );
      ...
      var n,
        o = class extends Error {
          ...
          constructor(...[t, e]) {
            ...
            if (e) {
              const { cause: t, ...i } = e;
              (t && (n = { cause: t }), Object.keys(i).length > 0 && (r = i));
            }
            (super(
              (function (t, e = {}) {
                {
                  ...
                  return (
                    Object.keys(e).length &&
                      (r += ` '${btoa(Object.entries(e).map(i).join("&"))}'`),
                    `${r}\``
                  );
                }
              })(t, r),
          ...
          return Object.freeze({
            ...(r = {
              ...
              write(t, r, i) {
                ...
                return (
                  e.set(new DataView(n), t, h(e.config)),
                  r.set(new Uint8Array(n), i),
                  i + e.size
                );
              },
            }),
                ...
                ...(r = {
                  ...
                  read(t, r = 0) {
                    ...
                    let a = new DataView(
                      ...
                      (f = i.byteOffset + (n ?? 0)),
                      (u = s ?? i.byteLength),
                      i.buffer.slice(f, f + u)),
                    );
                    return [e.get(a, h(e.config)), r + e.size];
                  },
                }),
    ...
    26801: (t, e) => {
      ...
      ((e.byteLength = function (t) {
        ...
        (e.fromByteArray = function (t) {
          for (
            var e, i = t.length, n = i % 3, o = [], s = 0, f = i - n;
            s < f;
            s += 16383
          )
            o.push(
    ...
    31367: (t, e, r) => {
      ...
      function o(t, e = !1) {
        let r = t.length,
          ...
          f = new Uint32Array(r);
        for (let o = 0; o < r; o++) {
          let { h: r, l: h } = (function (t, e = !1) {
            return e
              ? { h: Number(t & i), l: Number((t >> n) & i) }
              : { h: 0 | Number((t >> n) & i), l: 0 | Number(t & i) };
          })(t[o], e);
          [s[o], f[o]] = [r, h];
        }
        return [s, f];
      ...
      let y = (t, e, r) => (t >>> 0) + (e >>> 0) + (r >>> 0),
        v = (t, e, r, i) => (e + r + i + ((t / 0x100000000) | 0)) | 0,
        w = (t, e, r, i) => (t >>> 0) + (e >>> 0) + (r >>> 0) + (i >>> 0),
        b = (t, e, r, i, n) => (e + r + i + n + ((t / 0x100000000) | 0)) | 0,
        M = (t, e, r, i, n) =>
          (t >>> 0) + (e >>> 0) + (r >>> 0) + (i >>> 0) + (n >>> 0),
        x = (t, e, r, i, n, o) =>
    ...
    37800: (t, e, r) => {
      ...
      for (var s = [], f = 0; f < 256; ++f)
        s.push((f + 256).toString(16).substr(1));
      let h = function (t) {
          var e =
      ...
      t.exports = function (t) {
        ...
        function l(t) {
          ...
          for (
            ...
            var c = e[l];
            if (255 === c) return;
            for (var d = 0, p = s - 1; (0 !== c || d < o) && -1 !== p; p--, d++)
              ((c += (f * a[p]) >>> 0),
                (a[p] = c % 256 >>> 0),
                (c = (c / 256) >>> 0));
          ...
          for (var m = s - o; m !== s && 0 === a[m]; ) m++;
          var g = i.allocUnsafe(n + (s - m));
          g.fill(0, 0, n);
          for (var y = n; m !== s; ) g[y++] = a[m++];
          return g;
        }
        return {
          encode: function (e) {
            ...
            for (var r = 0, n = 0, o = 0, s = e.length; o !== s && 0 === e[o]; )
              (o++, r++);
            for (
              var u = ((s - o) * a + 1) >>> 0, l = new Uint8Array(u);
              o !== s;
            ...
            for (var m = u - n; m !== u && 0 === l[m]; ) m++;
            for (var g = h.repeat(r); m < u; ++m) g += t.charAt(l[m]);
            return g;
          },
          decodeUnsafe: l,
          decode: function (t) {
            var e = l(t);
            if (e) return e;
            throw Error("Non-base" + f + " character");
          },
        };
      };
    },
    43410: (t, e) => {
      ...
      function u(t) {
        ...
        this.handler = function (t, u) {
          ...
          if (!r(u, f, h))
            return ((i = s = n = 0), (f = 128), (h = 191), t.prepend(u), o(e));
          if (
            ((f = 128),
            (h = 191),
            (n += 1),
      ...
      ((f.prototype = {
        decode: function (t, e) {
          ...
          for (
            ...
            null !== o && (Array.isArray(o) ? f.push.apply(f, o) : f.push(o));
          if (!this._streaming) {
            do {
              if (-1 === (o = this._decoder.handler(s, s.read()))) break;
              if (null === o) continue;
              Array.isArray(o) ? f.push.apply(f, o) : f.push(o);
            } while (!s.endOfStream());
            this._decoder = null;
          }
          !f.length ||
        ...
        (h.prototype = {
          encode: function (t, e) {
            ((t = t ? String(t) : ""),
              (e = i(e)),
              this._streaming || (this._encoder = new a(this._options)),
              (this._streaming = !!e.stream));
            for (
              var r,
                o = [],
    ...
    43933: (t, e, r) => {
      ...
      ((t.exports = o),
        (o.prototype.request = function (t, e, r, i) {
          ...
          let u = !h && t && "object" == typeof t && "function" == typeof e;
          if (h || u) ((i = e), (f = t));
          else {
          ...
          try {
            o = JSON.stringify(f, this.options.replacer);
          } catch (t) {
            return i(t);
          }
          return (
    ...
    46135: (t, e, r) => {
      ...
      function b(t, e) {
        let r = (t.ORDER - a) / c,
          ...
          o = t.mul(e, n),
          s = t.mul(t.mul(o, f), n),
          h = t.mul(o, t.sub(s, t.ONE));
        return (v(t, h, e), h);
      }
      function M(t) {
        if (t < h) throw Error("sqrt is not defined for small field");
        let e = t - s,
          r = 0;
        for (; e % f === o; ) ((e /= f), r++);
        let i = f,
        ...
        return function (t, i) {
          if (t.is0(i)) return i;
          if (1 !== A(t, i)) throw Error("Cannot find square root");
          let n = r,
            o = t.mul(t.ONE, u),
            f = t.pow(i, e),
            h = t.pow(i, a);
          for (; !t.eql(f, t.ONE); ) {
            if (t.is0(f)) return t.ZERO;
            let e = 1,
              r = t.sqr(f);
            for (; !t.eql(r, t.ONE); )
              if ((e++, (r = t.sqr(r)), e === n))
            ...
            let i = s << BigInt(n - e - 1),
              u = t.pow(o, i);
            ((n = e), (o = t.sqr(u)), (f = t.mul(f, o)), (h = t.mul(h, u)));
          }
          return h;
        };
      }
      ...
      function A(t, e) {
        let r = (t.ORDER - s) / f,
          ...
          n = t.eql(i, t.ONE),
          o = t.eql(i, t.ZERO),
          h = t.eql(i, t.neg(t.ONE));
        if (!n && !o && !h) throw Error("invalid Legendre symbol result");
        return n ? 1 : o ? 0 : -1;
      }
      function S(t, e) {
        void 0 !== e && (0, n.Fe)(e);
      ...
      function I(t, e, r = !1, n = {}) {
        let f, g, x, E;
        if (t <= o) throw Error("invalid field: expected ORDER > 0, got " + t);
        let B = !1;
        if ("object" == typeof e && null != e) {
          ...
          (e.BITS && (g = e.BITS),
            ...
            "boolean" == typeof e.modFromBytes && (B = e.modFromBytes),
            (E = e.allowedLengths));
        } else ("number" == typeof e && (g = e), n.sqrt && (x = n.sqrt));
        let { nBitLength: A, nByteLength: O } = S(t, g);
        if (O > 2048)
        ...
        let R = Object.freeze({
          ...
          is0: (t) => t === o,
          isValidNot0: (t) => !R.is0(t) && R.isValid(t),
          isOdd: (t) => (t & s) === s,
          neg: (e) => m(-e, t),
          eql: (t, e) => t === e,
          sqr: (e) => m(e * e, t),
                    ...
                    return (
                      ...
                      (t, e) => {
                        let r = t.pow(e, s),
                          ...
                          a = t.eql(t.sqr(f), e),
                          l = t.eql(t.sqr(h), e);
                        ((r = t.cmov(r, f, a)), (f = t.cmov(u, h, l)));
                        let c = t.eql(t.sqr(f), e),
                          d = t.cmov(r, f, c);
                        return (v(t, d, e), d);
                      }
                    );
          ...
          toBytes: (t) => (r ? (0, i.z)(t, O) : (0, i.lq)(t, O)),
          fromBytes: (e, n = !0) => {
            if (E) {
              if (!E.includes(e.length) || e.length > O)
                throw Error(
                  "Field.fromBytes: expected " + E + " bytes, got " + e.length,
                );
            ...
            let o = r ? (0, i.lX)(e) : (0, i.Ph)(e);
            if ((B && (o = m(o, t)), !n && !R.isValid(o)))
      ...
      function U(t, e, r = !1) {
        let n = t.length,
          ...
          f = R(e);
        if (n < 16 || n < f || n > 1024)
          throw Error("expected " + f + "-1024 bytes of input, got " + n);
        let h = m(r ? (0, i.lX)(t) : (0, i.Ph)(t), e - s) + s;
        return r ? (0, i.z)(h, o) : (0, i.lq)(h, o);
      }
    },
    48070: (t, e, r) => {
      "use strict";
    ...
    49304: (t, e, r) => {
      ...
      function w(t, e, r) {
        ...
        let f = "",
          h = 0;
        for (; h < s; )
          f += String.fromCharCode.apply(String, o.slice(h, (h += 4096)));
        return f;
      }
      function b(t, e, r) {
      ...
      ((e.Buffer = f),
        ...
        (f.compare = function (t, e) {
          if (
            (C(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)),
            C(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)),
        ...
        (f.concat = function (t, e) {
          ...
          for (r = 0; r < t.length; ++r) {
            ...
            else if (f.isBuffer(e)) e.copy(i, n);
        ...
        (f.prototype.write = function (t, e, r, i) {
          ...
          for (;;)
            switch (i) {
              ...
              case "utf8":
              case "utf-8":
                return ((n = e), (o = r), j(L(t, this.length - n), this, n, o));
              case "ascii":
              case "latin1":
              case "binary":
                return (
        ...
        (f.prototype.readBigUInt64LE = N(function (t) {
          U((t >>>= 0), "offset");
          let e = this[t],
            r = this[t + 7];
        ...
        (f.prototype.readBigUInt64BE = N(function (t) {
          U((t >>>= 0), "offset");
          let e = this[t],
            r = this[t + 7];
          (void 0 === e || void 0 === r) && k(t, this.length - 8);
        ...
        (f.prototype.readBigInt64LE = N(function (t) {
          U((t >>>= 0), "offset");
          let e = this[t],
            r = this[t + 7];
          return (
        ...
        (f.prototype.readBigInt64BE = N(function (t) {
          U((t >>>= 0), "offset");
          let e = this[t],
            r = this[t + 7];
          return (
        ...
        (f.prototype.writeBigUInt64LE = N(function (t, e = 0) {
          return x(this, t, e, BigInt(0), BigInt("0xffffffffffffffff"));
        })),
        (f.prototype.writeBigUInt64BE = N(function (t, e = 0) {
        ...
        (f.prototype.writeBigInt64LE = N(function (t, e = 0) {
          return x(
            this,
            t,
            e,
        ...
        (f.prototype.writeBigInt64BE = N(function (t, e = 0) {
          return E(
            this,
            t,
            e,
        ...
        (f.prototype.fill = function (t, e, r, i) {
          ...
          if (
            ...
            let o = f.isBuffer(t) ? t : f.from(t, i),
              s = o.length;
            if (0 === s)
              throw TypeError(
          ...
          throw (
            (i =
              o > 3
                ? 0 === e || e === BigInt(0)
                  ? `>= 0${n} and < 2${n} ** ${(o + 1) * 8}${n}`
                  : `>= -(2${n} ** ${(o + 1) * 8 - 1}${n}) and < 2 ** ${(o + 1) * 8 - 1}${n}`
                : `>= ${e}${n} and <= ${r}${n}`),
            new S.ERR_OUT_OF_RANGE("value", i, t)
          );
        }
        (U(n, "offset"),
          (void 0 === i[n] || void 0 === i[n + o]) && k(n, i.length - (o + 1)));
      }
      function U(t, e) {
        if ("number" != typeof t)
    ...
    50302: (t, e, r) => {
      ...
      function h(t, e) {
        ...
        return e.map((e, i) => t.fromAffine(e.toAffine(r[i])));
      }
      function u(t, e) {
      ...
      function l(t, e, r) {
        let { windowSize: i, mask: n, maxNumber: o, shiftBy: f } = r,
          h = Number(t & n),
          u = t >> f;
        h > i && ((h -= o), (u += s));
        let a = e * i,
      ...
      function m(t) {
        if (t !== o) throw Error("invalid wNAF");
      }
      class g {
        constructor(t, e) {
          ((this.BASE = t.BASE),
        ...
        _unsafeLadder(t, e, r = this.ZERO) {
          let i = t;
          for (; e > o; )
            (e & s && (r = r.add(i)), (i = i.double()), (e >>= s));
          return r;
        }
        precomputeWindow(t, e) {
          let { windows: r, windowSize: i } = a(e, this.bits),
            n = [],
            o = t,
            s = o;
          for (let t = 0; t < r; t++) {
            ((s = o), n.push(s));
            for (let t = 1; t < i; t++) ((s = s.add(o)), n.push(s));
            o = s.double();
          }
          return n;
        }
        wNAF(t, e, r) {
          ...
          for (let t = 0; t < o.windows; t++) {
            ...
            ((r = s), u ? (n = n.add(f(c, e[d]))) : (i = i.add(f(a, e[h]))));
          }
          return (m(r), { p: i, f: n });
        }
        wNAFUnsafe(t, e, r, i = this.ZERO) {
          let n = a(t, this.bits);
          for (let t = 0; t < n.windows && r !== o; t++) {
            let { nextN: o, offset: s, isZero: f, isNeg: h } = l(r, t, n);
            if (((r = o), !f)) {
              let t = e[s];
              i = i.add(h ? t.negate() : t);
            }
          }
          return (m(r), i);
        }
        getPrecomputes(t, e, r) {
          ...
          return (
            i ||
              ...
              1 !== t && ("function" == typeof r && (i = r(i)), c.set(e, i))),
            i
          );
        }
        cached(t, e, r) {
        ...
        createCache(t, e) {
          (u(e, this.bits), d.set(t, e), c.delete(t));
        }
        hasCache(t) {
          return 1 !== p(t);
        }
      ...
      function v(t, e, r, n) {
        ...
        let f = t.ZERO,
          h = (0, i.dJ)(BigInt(o)),
          u = 1;
        h > 12 ? (u = h - 3) : h > 4 ? (u = h - 2) : h > 0 && (u = 2);
        let a = (0, i.OG)(u),
          l = Array(Number(a) + 1).fill(f),
        ...
        for (let t = c; t >= 0; t -= u) {
          ...
          let e = f;
          for (let t = l.length - 1, r = f; t > 0; t--)
            ((r = r.add(l[t])), (e = e.add(r)));
          if (((d = d.add(e)), 0 !== t))
            for (let t = 0; t < u; t++) d = d.double();
        }
        return d;
      }
      function w(t, e, r) {
        if (!e) return (0, n.D0)(t, { isLE: r });
        if (e.ORDER !== t)
          throw Error("Field.ORDER must match order: Fp == p, Fn == n");
        return ((0, n.jr)(e), e);
      }
      function b(t, e, r = {}, i) {
        if ((void 0 === i && (i = "edwards" === t), !e || "object" != typeof e))
          throw Error(`expected valid ${t} CURVE object`);
        for (let t of ["p", "n", "h"]) {
          let r = e[t];
          if (!("bigint" == typeof r && r > o))
            throw Error(`CURVE.${t} must be positive bigint`);
        }
        let n = w(e.p, r.Fp, i),
          s = w(e.n, r.Fn, i);
        for (let r of ["Gx", "Gy", "a", "weierstrass" === t ? "b" : "d"])
          if (!n.isValid(e[r]))
    ...
    53906: (t, e, r) => {
      ...
      class n extends i.Vw {
        ...
        update(t) {
          ((0, i.CC)(this), (t = (0, i.ZJ)(t)), (0, i.DO)(t));
          let { view: e, buffer: r, blockLen: n } = this,
            o = t.length;
          for (let s = 0; s < o; ) {
            let f = Math.min(n - this.pos, o - s);
            if (f === n) {
              let e = (0, i.O8)(t);
        ...
        digestInto(t) {
          ...
          (!(function (t, e, r, i) {
            ...
            let n = BigInt(32),
              ...
              h = 4 * !!i,
              u = 4 * !i;
            (t.setUint32(e + h, s, i), t.setUint32(e + u, f, i));
          ...
          let u = h / 4,
            a = this.get();
          if (u > a.length) throw Error("_sha2: outputLen bigger than state");
          for (let t = 0; t < u; t++) f.setUint32(4 * t, a[t], o);
        }
        digest() {
      ...
      class a extends n {
        ...
        get() {
          let { A: t, B: e, C: r, D: i, E: n, F: o, G: s, H: f } = this;
          return [t, e, r, i, n, o, s, f];
        }
        set(t, e, r, i, n, o, s, f) {
          ((this.A = 0 | t),
            (this.B = 0 | e),
        ...
        process(t, e) {
          ...
          let { A: r, B: n, C: o, D: s, E: f, F: a, G: l, H: c } = this;
          for (let t = 0; t < 64; t++) {
            var d, p, m, g;
            let e =
                (c +
      ...
      class g extends n {
        ...
        get() {
          ...
          return [t, e, r, i, n, o, s, f, h, u, a, l, c, d, p, m];
        }
        set(t, e, r, i, n, o, s, f, h, u, a, l, c, d, p, m) {
          ((this.Ah = 0 | t),
            (this.Al = 0 | e),
            (this.Bh = 0 | r),
            (this.Bl = 0 | i),
        ...
        process(t, e) {
          for (let r = 0; r < 16; r++, e += 4)
            ((p[r] = t.getUint32(e)), (m[r] = t.getUint32((e += 4))));
          for (let t = 16; t < 80; t++) {
            let e = 0 | p[t - 15],
              r = 0 | m[t - 15],
              i = f.rE(e, r, 1) ^ f.rE(e, r, 8) ^ f.xn(e, r, 7),
              n = f.ry(e, r, 1) ^ f.ry(e, r, 8) ^ f.jm(e, r, 7),
              o = 0 | p[t - 2],
              s = 0 | m[t - 2],
              h = f.rE(o, s, 19) ^ f.qh(o, s, 61) ^ f.xn(o, s, 6),
              u = f.ry(o, s, 19) ^ f.Ei(o, s, 61) ^ f.jm(o, s, 6),
              a = f.CW(n, u, m[t - 7], m[t - 16]),
              l = f.CQ(a, i, h, p[t - 7], p[t - 16]);
            ((p[t] = 0 | l), (m[t] = 0 | a));
          }
          let {
            Ah: r,
          ...
          for (let t = 0; t < 80; t++) {
            let e = f.rE(l, g, 14) ^ f.rE(l, g, 18) ^ f.qh(l, g, 41),
              E = f.ry(l, g, 14) ^ f.ry(l, g, 18) ^ f.Ei(l, g, 41),
              B = (l & y) ^ (~l & w),
              _ = (g & v) ^ (~g & b),
              A = f.F8(x, E, _, d[t], m[t]),
              S = f.TH(A, M, e, B, c[t], p[t]),
              I = 0 | A,
              O = f.rE(r, i, 28) ^ f.qh(r, i, 34) ^ f.qh(r, i, 39),
              R = f.ry(r, i, 28) ^ f.Ei(r, i, 34) ^ f.Ei(r, i, 39),
              U = (r & n) ^ (r & s) ^ (n & s),
              k = (i & o) ^ (i & h) ^ (o & h);
            ((M = 0 | w),
              (x = 0 | b),
              ...
              (o = 0 | i));
            let T = f.Vl(I, R, k);
            ((r = f.Vr(T, S, O, U)), (i = 0 | T));
          }
          (({ h: r, l: i } = f.WQ(0 | this.Ah, 0 | this.Al, 0 | r, 0 | i)),
            ({ h: n, l: o } = f.WQ(0 | this.Bh, 0 | this.Bl, 0 | n, 0 | o)),
            ({ h: s, l: h } = f.WQ(0 | this.Ch, 0 | this.Cl, 0 | s, 0 | h)),
            ({ h: u, l: a } = f.WQ(0 | this.Dh, 0 | this.Dl, 0 | u, 0 | a)),
            ({ h: l, l: g } = f.WQ(0 | this.Eh, 0 | this.El, 0 | l, 0 | g)),
            ({ h: y, l: v } = f.WQ(0 | this.Fh, 0 | this.Fl, 0 | y, 0 | v)),
            ({ h: w, l: b } = f.WQ(0 | this.Gh, 0 | this.Gl, 0 | w, 0 | b)),
            ({ h: M, l: x } = f.WQ(0 | this.Hh, 0 | this.Hl, 0 | M, 0 | x)),
            this.set(r, i, n, o, s, h, u, a, l, g, y, v, w, b, M, x));
        }
        roundClean() {
          (0, i.uH)(p, m);
        }
    ...
    57297: (t, e, r) => {
      ...
      function s(t, e = "") {
        if ("boolean" != typeof t)
          throw Error(
            (e && `"${e}"`) + "expected boolean, got type=" + typeof t,
          );
        return t;
      }
      function f(t, e, r = "") {
      ...
      function l(t) {
        return ((0, i.DO)(t), u((0, i.My)(Uint8Array.from(t).reverse())));
      }
      function c(t, e) {
        return (0, i.aT)(t.toString(16).padStart(2 * e, "0"));
      }
      function d(t, e) {
        return c(t, e).reverse();
      }
      function p(t, e, r) {
        let n;
        if ("string" == typeof e)
      ...
      function M(t, e, r) {
        ...
        let n = (t) => new Uint8Array(t),
          ...
          u = (...t) => r(s, o, ...t),
          a = (t = n(0)) => {
            ((s = u(Uint8Array.of(0), t)), (o = u()), 0 !== t.length) &&
              ((s = u(Uint8Array.of(1), t)), (o = u()));
          },
          l = () => {
            if (f++ >= 1e3) throw Error("drbg: tried 1000 values");
            let t = 0,
              r = [];
            for (; t < e; ) {
              let e = (o = u()).slice();
    ...
    62328: function (t, e, r) {
      "use strict";
      var i = r(49304).Buffer,
        n =
      ...
      ((e.baseEncode = function (t) {
        return (
          ...
          a.default.encode(i.from(t))
        );
      }),
        (e.baseDecode = function (t) {
          return i.from(a.default.decode(t));
        }));
      ...
      class p {
        ...
        writeU64(t) {
          (this.maybeResize(),
            this.writeBuffer(i.from(new u.default(t).toArray("le", 8))));
        }
        writeU128(t) {
          (this.maybeResize(),
            this.writeBuffer(i.from(new u.default(t).toArray("le", 16))));
        }
        writeU256(t) {
          (this.maybeResize(),
            this.writeBuffer(i.from(new u.default(t).toArray("le", 32))));
        }
        writeU512(t) {
          (this.maybeResize(),
            this.writeBuffer(i.from(new u.default(t).toArray("le", 64))));
        }
        writeBuffer(t) {
          ((this.buf = i.concat([
        ...
        try {
          ...
          if (r instanceof Array)
            if ("number" == typeof r[0]) return i.readFixedArray(r[0]);
              ...
              let n = [];
              for (let e = 0; e < r[1]; e++) n.push(b(t, null, r[0], i));
              return n;
            }
          if ("option" === r.kind) {
    ...
    64411: (t) => {
      ...
      function o(t, e, i, o, s) {
        ...
        return (
          t._events[h]
            ? t._events[h].fn
              ? (t._events[h] = [t._events[h], f])
              : t._events[h].push(f)
            : ((t._events[h] = f), t._eventsCount++),
          t
        );
      }
      function s(t, e) {
      ...
      (Object.create &&
        ...
        (f.prototype.emit = function (t, e, i, n, o, s) {
          var f = r ? r + t : t;
          ...
          if (a.fn) {
            switch ((a.once && this.removeListener(t, a.fn, void 0, !0), l)) {
              ...
              case 3:
                return (a.fn.call(a.context, e, i), !0);
              case 4:
                return (a.fn.call(a.context, e, i, n), !0);
              case 5:
                return (a.fn.call(a.context, e, i, n, o), !0);
              case 6:
                return (a.fn.call(a.context, e, i, n, o, s), !0);
            }
            ...
            for (u = 0; u < d; u++)
              switch (
                ...
                case 2:
                  ...
                  break;
                case 3:
                  a[u].fn.call(a[u].context, e, i);
                  break;
                case 4:
                  a[u].fn.call(a[u].context, e, i, n);
                  break;
                default:
                  if (!h)
                    for (c = 1, h = Array(l - 1); c < l; c++)
                      h[c - 1] = arguments[c];
        ...
        (f.prototype.removeListener = function (t, e, i, n) {
          var o = r ? r + t : t;
          ...
          if (f.fn)
            ...
            for (var h = 0, u = [], a = f.length; h < a; h++)
              (f[h].fn !== e ||
                (n && !f[h].once) ||
                (i && f[h].context !== i)) &&
                u.push(f[h]);
    ...
    67864: (t, e, r) => {
      ...
      let u = (t, e, r) => new h(t, e).update(r).digest();
      u.create = (t, e) => new h(t, e);
      var a = r(57297),
        l = r(50302),
        c = r(46135);
      let d = (t, e) => (t + (t >= 0 ? e : -e) / b) / e;
      function p(t) {
      ...
      function m(t, e) {
        let r = {};
        for (let i of Object.keys(e)) r[i] = void 0 === t[i] ? e[i] : t[i];
        return (
          (0, a.d6)(r.lowS, "lowS"),
          (0, a.d6)(r.prehash, "prehash"),
          void 0 !== r.format && p(r.format),
          r
        );
      }
      ...
      let y = {
          ...
          _tlv: {
            encode: (t, e) => {
              ...
              let o = i > 127 ? (0, a.zW)((n.length / 2) | 128) : "";
              return (0, a.zW)(t) + o + n + e;
            },
            decode(t, e) {
              let { Err: r } = y,
                i = 0;
          ...
          toSig(t) {
            let { Err: e, _int: r, _tlv: i } = y,
              n = (0, a.qj)("signature", t),
              { v: o, l: s } = i.decode(48, n);
            if (s.length)
              throw new e("invalid signature: left bytes after parsing");
            let { v: f, l: h } = i.decode(2, o),
              { v: u, l: l } = i.decode(2, h);
            if (l.length)
              throw new e("invalid signature: left bytes after parsing");
      ...
      function E(t, e) {
        ...
        if ("bigint" == typeof e) r = e;
          ...
          let n = (0, a.qj)("private key", e);
          try {
            r = t.fromBytes(n);
          } catch (t) {
            throw Error(
              `invalid private key: expected ui8a of size ${i}, got ${typeof e}`,
            );
          }
        }
        if (!t.isValidNot0(r))
        ...
        O = (0, c.D0)(A.p, {
          sqrt: function (t) {
            let e = A.p,
              ...
              x = ((0, c.zH)(M, i, e) * u) % e,
              E = (0, c.zH)(x, I, e);
            if (!O.eql(O.sqr(E), t)) throw Error("Cannot find square root");
            return E;
          },
        }),
        R =
          ((n = { ...A, Fp: O, lowS: !0, endo: S }),
          (o = s.sc),
          {
            ...(i = (t) =>
              (function (t) {
                let e,
                  {
                    ...
                    let e,
                      ...
                      { CURVE: o, curveOpts: s } =
                        ...
                        (r = t.Fp),
                        (i = t.allowedPrivateKeyLengths
                          ? Array.from(
                              new Set(
                                t.allowedPrivateKeyLengths.map((t) =>
                                  Math.ceil(t / 2),
                                ),
                              ),
                            )
                  ...
                  s = (function (t, e, r = {}) {
                    ...
                    let i = r.randomBytes || f.po,
                      n = r.hmac || ((t, ...r) => u(e, t, (0, f.Id)(...r))),
                      { Fp: o, Fn: s } = t,
                      { ORDER: h, BITS: l } = s,
                      {
                        keygen: d,
                        ...
                        let { Fn: r } = t,
                          i = e.randomBytes || f.po,
                          n = Object.assign(_(t.Fp, r), {
                            seed: (0, c.Tp)(r.ORDER),
                          });
                        function o(t) {
                          try {
                        ...
                        function s(t = i(n.seed)) {
                          return (0, c.qy)(
                            (0, a.eV)(t, n.seed, "seed"),
                            r.ORDER,
                          );
                        }
                        function h(e, i = !0) {
                          return t.BASE.multiply(E(r, e)).toBytes(i);
                        }
                        function u(e) {
                          ...
                          let f = (0, a.qj)("key", e).length;
                          return f === o || f === s;
                        }
                        return Object.freeze({
                          getPublicKey: h,
                          getSharedSecret: function (e, i, n = !0) {
                            if (!0 === u(e))
                              throw Error("first arg must be private key");
                            if (!1 === u(i))
                              throw Error("second arg must be public key");
                            let o = E(r, e);
                            return t.fromHex(i).multiply(o).toBytes(n);
                          },
                          keygen: function (t) {
                            let e = s(t);
                            return { secretKey: e, publicKey: h(e) };
                          },
                          Point: t,
                          utils: {
                            isValidSecretKey: o,
                            isValidPublicKey: function (e, r) {
                              let { publicKey: i, publicKeyUncompressed: o } =
                                n;
                              try {
                                let n = e.length;
                                if (
                            ...
                            isValidPrivateKey: o,
                            randomPrivateKey: s,
                            normPrivateKeyToScalar: (t) => E(r, t),
                            precompute: (e = 8, r = t.BASE) =>
                              r.precompute(e, !1),
                          },
                          lengths: n,
                        });
                    ...
                    function O(t, e) {
                      if (!s.isValidNot0(e))
                        throw Error(
                          `invalid signature ${t}: out of range 1..Point.Fn.ORDER`,
                        );
                      return e;
                    }
                    class R {
                      ...
                      static fromBytes(t, e = I) {
                        ...
                        if (
                          ...
                          let { r: e, s: r } = y.toSig((0, a.eV)(t));
                          return new R(e, r);
                        }
                        "recovered" === e &&
                          ((n = t[0]), (e = "compact"), (t = t.subarray(1)));
                        let f = s.BYTES,
                          h = t.subarray(0, f),
                          u = t.subarray(f, 2 * f);
                        return new R(s.fromBytes(h), s.fromBytes(u), n);
                      }
                      static fromHex(t, e) {
                        return this.fromBytes((0, f.aT)(t), e);
                      }
                      addRecoveryBit(t) {
                        return new R(this.r, this.s, t);
                      }
                      recoverPublicKey(e) {
                        let r = o.ORDER,
                          { r: i, s: n, recovery: u } = this;
                        ...
                        let c = o.toBytes(l),
                          d = t.fromBytes((0, f.Id)(B((1 & u) == 0), c)),
                          p = s.inv(l),
                          m = k((0, a.qj)("msgHash", e)),
                          g = s.create(-m * p),
                          y = s.create(n * p),
                          v = t.BASE.multiplyUnsafe(g).add(d.multiplyUnsafe(y));
                        if (v.is0()) throw Error("point at infinify");
                      ...
                      toBytes(t = I) {
                        if ((p(t), "der" === t))
                          return (0, f.aT)(y.hexFromSig(this));
                        let e = s.toBytes(this.r),
                          r = s.toBytes(this.s);
                        if ("recovered" === t) {
                          if (null == this.recovery)
                            throw Error("recovery bit must be present");
                          return (0, f.Id)(Uint8Array.of(this.recovery), e, r);
                        }
                        return (0, f.Id)(e, r);
                      }
                      toHex(t) {
                        return (0, f.My)(this.toBytes(t));
                      }
                      assertValidity() {}
                      static fromCompact(t) {
                        return R.fromBytes((0, a.qj)("sig", t), "compact");
                      }
                      static fromDER(t) {
                        return R.fromBytes((0, a.qj)("sig", t), "der");
                      }
                      normalizeS() {
                        return this.hasHighS()
                          ? new R(this.r, s.neg(this.s), this.recovery)
                          : this;
                      }
                      toDERRawBytes() {
                      ...
                      toDERHex() {
                        return (0, f.My)(this.toBytes("der"));
                      }
                      toCompactRawBytes() {
                        return this.toBytes("compact");
                      }
                      toCompactHex() {
                        return (0, f.My)(this.toBytes("compact"));
                      }
                    }
                    let U =
                        r.bits2int ||
                      ...
                      T = (0, a.OG)(l);
                    function L(t) {
                      return ((0, a.aK)("num < 2^" + l, t, v, T), s.toBytes(t));
                    }
                    function q(t, r) {
                      return (
                        (0, a.eV)(t, void 0, "message"),
                        r ? (0, a.eV)(e(t), void 0, "prehashed message") : t
                      );
                    }
                    return Object.freeze({
                      keygen: d,
                      ...
                      Point: t,
                      sign: function (r, o, u = {}) {
                        let { seed: l, k2sig: c } = (function (e, r, n) {
                          ...
                          let {
                            ...
                            p = [L(d), L(c)];
                          if (null != l && !1 !== l) {
                            let t = !0 === l ? i(A.secretKey) : l;
                            p.push((0, a.qj)("extraEntropy", t));
                          }
                          return {
                            seed: (0, f.Id)(...p),
                            k2sig: function (e) {
                              ...
                              let i = s.inv(r),
                                n = t.BASE.multiply(r).toAffine(),
                                f = s.create(n.x);
                              if (f === v) return;
                              let u = s.create(i * s.create(c + f * d));
                              if (u === v) return;
                              let a = (2 * (n.x !== f)) | Number(n.y & w),
                                l = u;
                              return (
                                o && u > h >> w && ((l = s.neg(u)), (a ^= 1)),
                                new R(f, l, a)
                              );
                            },
                          };
                        })((r = (0, a.qj)("message", r)), o, u);
                        return (0, a.fg)(e.outputLen, s.BYTES, n)(l, c);
                      },
                      verify: function (e, r, i, n = {}) {
                        let { lowS: o, prehash: h, format: u } = m(n, S);
                        if (
                          ((i = (0, a.qj)("publicKey", i)),
                          (r = q((0, a.qj)("message", r), h)),
                          "strict" in n)
                        )
                        ...
                        let l =
                          void 0 === u
                            ? (function (t) {
                                ...
                                if (i) e = new R(t.r, t.s);
                                else if (r) {
                                  try {
                                    e = R.fromBytes((0, a.qj)("sig", t), "der");
                                  } catch (t) {
                                    if (!(t instanceof y.Err)) throw t;
                                  }
                                  if (!e)
                                    try {
                                      e = R.fromBytes(
                            ...
                            : R.fromBytes((0, a.qj)("sig", e), u);
                        if (!1 === l) return !1;
                        try {
                          let e = t.fromBytes(i);
                          if (o && l.hasHighS()) return !1;
                          let { r: n, s: f } = l,
                            h = k(r),
                            u = s.inv(f),
                            a = s.create(h * u),
                            c = s.create(n * u),
                            d = t.BASE.multiplyUnsafe(a).add(
                              e.multiplyUnsafe(c),
                            );
                          if (d.is0()) return !1;
                          return s.create(d.x) === n;
                        } catch (t) {
                          return !1;
                        }
                      },
                    ...
                    (function (t, e = {}) {
                      ...
                      let m =
                          e.toBytes ||
                          function (t, e, r) {
                            let { x: n, y: o } = e.toAffine(),
                              s = i.toBytes(n);
                            if (((0, a.d6)(r, "isCompressed"), !r))
                              return (0, f.Id)(
                                Uint8Array.of(4),
                                s,
                                i.toBytes(o),
                        ...
                        g =
                          e.fromBytes ||
                          function (t) {
                            (0, a.eV)(t, void 0, "Point");
                            let { publicKey: e, publicKeyUncompressed: r } = c,
                              n = t.length,
                              o = t[0],
                              s = t.subarray(1);
                            if (n === e && (2 === o || 3 === o)) {
                              ...
                              return (
                                p(),
                                ((1 & o) == 1) !== i.isOdd(t) && (t = i.neg(t)),
                                { x: e, y: t }
                              );
                            }
                            if (n === r && 4 === o) {
                              let t = i.BYTES,
                                e = i.fromBytes(s.subarray(0, t)),
                                r = i.fromBytes(s.subarray(t, 2 * t));
                              if (!b(e, r))
                                throw Error("bad point: is not on curve");
                              return { x: e, y: r };
                            }
                            throw Error(
                              `bad point: got length ${n}, expected compressed=${e} or uncompressed=${r}`,
                            );
                          };
                      function y(t) {
                        let e = i.sqr(t),
                          r = i.mul(e, t);
                        return i.add(i.add(r, i.mul(t, o.a)), o.b);
                      }
                      function b(t, e) {
                        let r = i.sqr(e),
                          n = y(t);
                      ...
                      let A = i.mul(i.pow(o.a, M), x),
                        S = i.mul(i.sqr(o.b), BigInt(27));
                      if (i.is0(i.add(A, S)))
                        throw Error("bad curve params: a or b");
                      function I(t, e, r = !1) {
                        if (!i.isValid(e) || (r && i.is0(e)))
                      ...
                      function R(t) {
                        ...
                        return (function (t, e, r) {
                          let [[i, n], [o, s]] = e,
                            ...
                            p = l < v;
                          (c && (u = -u), p && (l = -l));
                          let m = (0, a.OG)(Math.ceil((0, a.dJ)(r) / 2)) + w;
                          if (u < v || u >= m || l < v || l >= m)
                            throw Error(
                      ...
                      let U = (0, a.x)((t, e) => {
                        ...
                        k = (0, a.x)((t) => {
                          if (t.is0()) {
                            if (e.allowInfinityPoint && !i.is0(t.Y)) return;
                            throw Error("bad point: ZERO");
                          }
                          let { x: r, y: n } = t.toAffine();
                      ...
                      class L {
                        ...
                        static fromAffine(t) {
                          let { x: e, y: r } = t || {};
                          if (!t || !i.isValid(e) || !i.isValid(r))
                            throw Error("invalid affine point");
                          if (t instanceof L)
                            throw Error("projective point not allowed");
                          return i.is0(e) && i.is0(r)
                            ? L.ZERO
                            : new L(e, r, i.ONE);
                        }
                        static fromBytes(t) {
                          let e = L.fromAffine(
                            g((0, a.eV)(t, void 0, "point")),
                          );
                          return (e.assertValidity(), e);
                        }
                        static fromHex(t) {
                          return L.fromBytes((0, a.qj)("pointHex", t));
                        }
                        get x() {
                        ...
                        equals(t) {
                          O(t);
                          let { X: e, Y: r, Z: n } = this,
                            { X: o, Y: s, Z: f } = t,
                            h = i.eql(i.mul(e, f), i.mul(o, n)),
                            u = i.eql(i.mul(r, f), i.mul(s, n));
                          return h && u;
                        }
                        negate() {
                          return new L(this.X, i.neg(this.Y), this.Z);
                        }
                        double() {
                          let { a: t, b: e } = o,
                            r = i.mul(e, M),
                        ...
                        multiply(t) {
                          ...
                          let s = (t) =>
                            j.cached(this, t, (t) => (0, l.Ak)(L, t));
                          if (o) {
                            let { k1neg: e, k1: n, k2neg: f, k2: h } = R(t),
                              { p: u, f: a } = s(n),
                              { p: l, f: c } = s(h);
                            ((i = a.add(c)), (r = T(o.beta, u, l, e, f)));
                          } else {
                            let { p: e, f: n } = s(t);
                            ((r = e), (i = n));
                          }
                          return (0, l.Ak)(L, [r, i])[0];
                        }
                        multiplyUnsafe(t) {
                          let { endo: r } = e;
                          if (!n.isValid(t))
                          ...
                          if (t === w) return this;
                          if (j.hasCache(this)) return this.multiply(t);
                          if (!r) return j.unsafe(this, t);
                          {
                            let { k1neg: e, k1: i, k2neg: n, k2: o } = R(t),
                              { p1: s, p2: f } = (0, l.fH)(L, this, i, o);
                            return T(r.beta, s, f, e, n);
                          }
                        }
                        multiplyAndAddUnsafe(t, e, r) {
                          let i = this.multiplyUnsafe(e).add(
                            t.multiplyUnsafe(r),
                          );
                        ...
                        isTorsionFree() {
                          ...
                          return (
                            s === w ||
                            (t ? t(L, this) : j.unsafe(this, h).is0())
                          );
                        }
                        clearCofactor() {
                        ...
                        static msm(t, e) {
                          return (0, l.Xf)(L, n, t, e);
                        }
                        static fromPrivateKey(t) {
                          return L.BASE.multiply(E(n, t));
                        }
                      }
                      ((L.BASE = new L(o.Gx, o.Gy, i.ONE)),
                        (L.ZERO = new L(i.ZERO, i.ONE, i.ZERO)),
                        (L.Fp = i),
                        (L.Fn = n));
                      let q = n.BITS,
                        j = new l.hT(L, e.endo ? Math.ceil(q / 2) : q);
    ...
    70542: (t, e, r) => {
      ...
      class u extends h {
        ...
        isCount() {
          return this.layout instanceof a || this.layout instanceof l;
        }
        decode(t, e = 0) {
      ...
      class g extends s {
        constructor(t, e, r) {
          ...
          let i = -1;
          (e instanceof h || !(0 < t.span) || (i = e * t.span),
            super(i, r),
        ...
        decode(t, e = 0) {
          let r = [],
            i = 0,
            n = this.count;
          for (n instanceof h && (n = n.decode(t, e)); i < n; )
        ...
        encode(t, e, r = 0) {
          ...
          return (
            this.count instanceof h && this.count.encode(t.length, e, r),
            n
          );
        }
      }
      class y extends s {
        constructor(t, e, r) {
          ...
          for (const i of ("boolean" == typeof e &&
            void 0 === r &&
            ((r = e), (e = void 0)),
          t))
      ...
      class w extends s {
        constructor(t, e, r) {
          if (!(t instanceof a || t instanceof l))
      ...
      class b {
        constructor(t, e, r) {
          ...
          ((this.container = t),
            ...
            (this.wordMask = v(this.valueMask << this.start)),
            (this.property = r));
        }
        decode(t, e) {
          return (
            v(this.container._packedGetValue() & this.wordMask) >>> this.start
          );
        }
        encode(t) {
          if (
            "number" != typeof t ||
            !Number.isInteger(t) ||
            t !== v(t & this.valueMask)
          )
            throw TypeError(
              f("BitField.encode", this) +
                " value must be integer not exceeding " +
                this.valueMask,
            );
          let e = this.container._packedGetValue(),
            r = v(t << this.start);
          this.container._packedSetValue(v(e & ~this.wordMask) | r);
        }
      }
      class M extends b {
        constructor(t, e) {
        ...
        encode(t) {
          ("boolean" == typeof t && (t *= 1), super.encode(t));
        }
      }
      class x extends s {
        constructor(t, e) {
        ...
        encode(t, e, r) {
          let i = this.length;
          if (
            (this.length instanceof h && (i = t.length),
          ...
          return (
            ...
            this.length instanceof h && this.length.encode(i, e, r),
            i
          );
        }
      }
      ((e.cY = (t, e, r) => new u(t, e, r)),
        ...
        (e.I0 = (t) => new p(t)),
        (e.Wg = (t) => new m(t)),
        (e.w3 = (t, e, r) => new y(t, e, r)),
        (e.O6 = (t, e, r) => new g(t, e, r)),
        (e.av = (t, e) => new x(t, e)));
    },
    71248: (t, e, r) => {
      "use strict";
      ...
      function M(t, e) {
        ...
        let i,
          ...
          (M = ((0, f.zH)(w, s, v) * y) % v),
          (x = ((0, f.zH)(M, i, v) * l) % v),
          { pow_p_5_8: ((0, f.zH)(x, m, v) * r) % v, b2: h }).pow_p_5_8,
          _ = (0, f.zi)(t * E * B, v),
          A = (0, f.zi)(e * _ * _, v),
          S = _,
          I = (0, f.zi)(_ * b, v),
        ...
        return (
          O && (_ = S),
          (R || U) && (_ = I),
          (0, f.dQ)(_, v) && (_ = (0, f.zi)(-_, v)),
          { isValid: O || R, value: _ }
        );
      }
      let x = (0, f.D0)(w.p, { isLE: !0 }),
        E = (0, f.D0)(w.n, { isLE: !0 }),
        B = (function (t) {
          let e,
            r,
            ...
            { CURVE: e, curveOpts: r, hash: t.hash, eddsaOpts: i }),
            y = (function (t, e, r = {}) {
              ...
              let { prehash: i } = r,
                { BASE: o, Fp: f, Fn: h } = t,
                a = r.randomBytes || n.po,
                l = r.adjustScalarBytes || ((t) => t),
                c =
                  r.domain ||
                  ((t, e, r) => {
                    if (((0, s.d6)(r, "phflag"), e.length || r))
                      throw Error("Contexts/pre-hash are not supported");
                    return t;
                  });
              function d(t) {
                return h.create((0, s.lX)(t));
              }
              function p(t) {
                var r;
                let i,
                  ...
                  (i = w.secretKey),
                  (r = (0, s.qj)("private key", r, i)),
                  (f = l(
                    (n = (0, s.qj)("hashed private key", e(r), 2 * i)).slice(
                      0,
                      i,
                    ),
                  )),
              ...
              function g(t = Uint8Array.of(), ...r) {
                return d(e(c((0, n.Id)(...r), (0, s.qj)("context", t), !!i)));
              }
              let y = { zip215: !0 },
                v = f.BYTES,
                w = { secretKey: v, publicKey: v, signature: 2 * v, seed: v };
              function b(t = a(w.seed)) {
                return (0, s.eV)(t, w.seed, "seed");
              }
              let M = {
                getExtendedPublicKey: p,
                randomSecretKey: b,
                isValidSecretKey: function (t) {
                  return (0, n.aY)(t) && t.length === h.BYTES;
                },
                isValidPublicKey: function (e, r) {
                  try {
                ...
                toMontgomery(e) {
                  let { y: r } = t.fromBytes(e),
                    i = w.publicKey,
                    n = 32 === i;
                  if (!n && 57 !== i)
                    throw Error("only defined for 25519 and 448");
                  let o = n ? f.div(u + r, u - r) : f.div(r - u, r + u);
                  return f.toBytes(o);
                },
                toMontgomerySecret(t) {
                  ...
                  return (
                    (0, s.eV)(t, r),
                    l(e(t.subarray(0, r))).subarray(0, r)
                  );
                },
                randomPrivateKey: b,
              ...
              return Object.freeze({
                keygen: function (t) {
                  let e = M.randomSecretKey(t);
                  return { secretKey: e, publicKey: m(e) };
                },
                getPublicKey: m,
                sign: function (t, e, r = {}) {
                  ((t = (0, s.qj)("message", t)), i && (t = i(t)));
                  let { prefix: f, scalar: u, pointBytes: a } = p(e),
                    l = g(r.context, f, t),
                    c = o.multiply(l).toBytes(),
                    d = g(r.context, c, a, t),
                    m = h.create(l + d * u);
                  if (!h.isValid(m)) throw Error("sign failed: invalid s");
                  let y = (0, n.Id)(c, h.toBytes(m));
                  return (0, s.eV)(y, w.signature, "result");
                },
                verify: function (e, r, n, f = y) {
                  let h,
                    u,
                    a,
                    { context: l, zip215: c } = f,
                    d = w.signature;
                  ((e = (0, s.qj)("signature", e, d)),
                    (r = (0, s.qj)("message", r)),
                    (n = (0, s.qj)("publicKey", n, w.publicKey)),
                    void 0 !== c && (0, s.d6)(c, "zip215"),
                    i && (r = i(r)));
                  let p = d / 2,
                    m = e.subarray(0, p),
                    v = (0, s.lX)(e.subarray(p, d));
                  try {
                    ((h = t.fromBytes(n, c)),
                      (u = t.fromBytes(m, c)),
                      (a = o.multiplyUnsafe(v)));
                  } catch (t) {
                    return !1;
                  }
                  if (!c && h.isSmallOrder()) return !1;
                  let b = g(l, u.toBytes(), h.toBytes(), r);
                  return u
                    .add(h.multiplyUnsafe(b))
                    .subtract(a)
                    .clearCofactor()
                    .is0();
                },
              ...
              (function (t, e = {}) {
                ...
                let f,
                  ...
                  p,
                  m,
                  g = (0, o.UT)("edwards", t, e, e.FpFnLE),
                  { Fp: y, Fn: v } = g,
                  w = g.CURVE,
                  { h: b } = w;
                (0, s.DS)(e, {}, { uvRatio: "function" });
                let M = a << (BigInt(8 * v.BYTES) - u),
                  x =
                    e.uvRatio ||
                    ((t, e) => {
                      try {
                        return { isValid: !0, value: y.sqrt(y.div(t, e)) };
                      } catch (t) {
                ...
                if (
                  ...
                  (f = y.sqr(r)),
                  (c = y.sqr(i)),
                  (d = y.add(y.mul(w.a, f), c)),
                  (p = y.add(y.ONE, y.mul(w.d, y.mul(f, c)))),
                  !y.eql(d, p))
                )
                  throw Error("bad curve params: generator point");
                function E(t, e, r = !1) {
                  let i = r ? u : h;
                  return ((0, s.aK)("coordinate " + t, e, i, M), e);
                }
                function B(t) {
                ...
                let _ = (0, s.x)((t, e) => {
                    let r,
                      ...
                      { X: n, Y: o, Z: s } = t,
                      f = t.is0();
                    null == e && (e = f ? l : y.inv(s));
                    let a = ((r = n * e), y.create(r)),
                      c = ((i = o * e), y.create(i)),
                      d = y.mul(s, e);
                    if (f) return { x: h, y: u };
                    if (d !== u) throw Error("invZ was invalid");
                    return { x: a, y: c };
                  }),
                  A = (0, s.x)((t) => {
                    let e,
                    ...
                    if (
                      ((f =
                        E * ((o = M * d), (s = y.create(o) + x), y.create(s))),
                      y.create(f) !==
                        ((a =
                          B +
                          ((u = p * ((h = M * x), y.create(h))), y.create(u))),
                        y.create(a)))
                    )
                      throw Error("bad point: equation left != right (1)");
                    if (
                      ((l = m * g), y.create(l) !== ((c = v * b), y.create(c)))
                    )
                ...
                class S {
                  ...
                  static fromBytes(t, e = !1) {
                    ...
                    let p = (0, s.lX)(c),
                      m = e ? M : y.ORDER;
                    (0, s.aK)("point.y", p, h, m);
                    let g = ((r = p * p), y.create(r)),
                      { isValid: v, value: b } = x(
                        ((i = g - u), y.create(i)),
                        ((n = l * g - a), y.create(n)),
                      );
                    ...
                    return (
                      B !== E && ((o = -b), (b = y.create(o))),
                      S.fromAffine({ x: b, y: p })
                    );
                  }
                  static fromHex(t, e = !1) {
                    return S.fromBytes((0, s.qj)("point", t), e);
                  }
                  get x() {
                    return this.toAffine().x;
                  }
                  ...
                  double() {
                    let t,
                      ...
                      g = ((t = d * d), y.create(t)),
                      v = ((e = p * p), y.create(e)),
                      b = ((i = a * ((r = m * m), y.create(r))), y.create(i)),
                      M = ((n = c * g), y.create(n)),
                      x = d + p,
                      E = ((o = x * x), (s = y.create(o) - g - v), y.create(s)),
                      B = M + v,
                      _ = B - b,
                      A = M - v,
                      I = ((f = E * _), y.create(f)),
                      O = ((h = B * A), y.create(h)),
                      R = ((u = E * A), y.create(u));
                    return new S(I, O, ((l = _ * B), y.create(l)), R);
                  }
                  add(t) {
                    let e, r, i, n, o, s, f, h, u, a;
                    B(t);
                    let { a: l, d: c } = w,
                      { X: d, Y: p, Z: m, T: g } = this,
                      { X: v, Y: b, Z: M, T: x } = t,
                      E = ((e = d * v), y.create(e)),
                      _ = ((r = p * b), y.create(r)),
                      A = ((i = g * c * x), y.create(i)),
                      I = ((n = m * M), y.create(n)),
                      O = ((o = (d + p) * (v + b) - E - _), y.create(o)),
                      R = I - A,
                      U = I + A,
                      k = ((s = _ - l * E), y.create(s)),
                      T = ((f = O * R), y.create(f)),
                      L = ((h = U * k), y.create(h)),
                      q = ((u = O * k), y.create(u));
                    return new S(T, L, ((a = R * U), y.create(a)), q);
                  }
                  subtract(t) {
                    return this.add(t.negate());
                  }
                  multiply(t) {
                    ...
                    let { p: e, f: r } = I.cached(this, t, (t) =>
                      (0, o.Ak)(S, t),
                    );
                    return (0, o.Ak)(S, [e, r])[0];
                  }
                  multiplyUnsafe(t, e = S.ZERO) {
                    if (!v.isValid(t))
                    ...
                    return t === h
                      ...
                      : this.is0() || t === u
                        ? this
                        : I.unsafe(this, t, (t) => (0, o.Ak)(S, t), e);
                  }
                  isSmallOrder() {
                    return this.multiplyUnsafe(b).is0();
                  }
                  isTorsionFree() {
                    return I.unsafe(this, w.n).is0();
                  }
                  toAffine(t) {
                    return _(this, t);
                  }
                  clearCofactor() {
                    return b === u ? this : this.multiplyUnsafe(b);
                  }
                  toBytes() {
                    let { x: t, y: e } = this.toAffine(),
                      r = y.toBytes(e);
                    return ((r[r.length - 1] |= t & u ? 128 : 0), r);
                  }
                  toHex() {
                    return (0, n.My)(this.toBytes());
                  }
                ...
                ((S.BASE = new S(
                  ...
                  w.Gy,
                  u,
                  ((m = w.Gx * w.Gy), y.create(m)),
                )),
                  (S.ZERO = new S(h, u, u, h)),
                  (S.Fp = y),
                  (S.Fn = v));
                let I = new o.hT(S, v.BITS);
          ...
          return (
            ...
            Object.assign({}, y, {
              ExtendedPoint: c,
              CURVE: t,
              nBitLength: c.Fn.BITS,
              nByteLength: c.Fn.BYTES,
            })
          );
        })({
          ...w,
        ...
        R = (t) => B.Point.Fp.create((0, s.lX)(t) & O);
      function U(t) {
        let e,
          r,
          i,
          ...
          y,
          { d: E } = w,
          A = ((e = b * t * t), x.create(e)),
          O = ((r = (A + p) * S), x.create(r)),
          R = BigInt(-1),
          U = ((n = (R - E * A) * ((i = A + E), x.create(i))), x.create(n)),
          { isValid: k, value: T } = M(O, U),
          L = ((o = T * t), x.create(o));
        ((0, f.dQ)(L, v) || ((s = -L), (L = x.create(s))),
          k || (T = L),
          k || (R = A));
        let q = ((h = R * (A - p) * I - U), x.create(h)),
          j = T * T,
          C = ((u = (T + T) * U), x.create(u)),
          z = ((a = q * _), x.create(a)),
          N = ((l = p - j), x.create(l)),
          P = ((c = p + j), x.create(c));
        return new B.Point(
      ...
      class k extends c {
        ...
        static fromAffine(t) {
          return new k(B.Point.fromAffine(t));
        }
        assertSame(t) {
          if (!(t instanceof k)) throw Error("RistrettoPoint expected");
        }
        init(t) {
          return new k(t);
        }
        static hashToCurve(t) {
          ...
          let r, i;
          return (
            (e = (0, s.qj)("ristrettoHash", t, 64)),
            (0, n.DO)(e, 64),
            (r = U(R(e.subarray(0, 32)))),
            (i = U(R(e.subarray(32, 64)))),
            new k(r.add(i))
          );
        }
        static fromBytes(t) {
          let e, r, i, o, h, u, a, l, c, m, g, y, b;
          (0, n.DO)(t, 32);
          let { a: E, d: _ } = w,
            A = R(t);
          if (!(0, s.ex)(x.toBytes(A), t) || (0, f.dQ)(A, v))
            throw Error("invalid ristretto255 encoding 1");
          let S = ((e = A * A), x.create(e)),
            I = ((r = p + E * S), x.create(r)),
            O = ((i = p - E * S), x.create(i)),
            U = ((o = I * I), x.create(o)),
            T = ((h = O * O), x.create(h)),
            L = ((u = E * _ * U - T), x.create(u)),
            { isValid: q, value: j } = ((a = L * T), M(p, x.create(a))),
            C = ((l = j * O), x.create(l)),
            z = ((c = j * C * L), x.create(c)),
            N = ((m = (A + A) * C), x.create(m));
          (0, f.dQ)(N, v) && ((g = -N), (N = x.create(g)));
          let P = ((y = I * z), x.create(y)),
            F = ((b = N * P), x.create(b));
          if (!q || (0, f.dQ)(F, v) || P === d)
            throw Error("invalid ristretto255 encoding 2");
          return new k(new B.Point(N, P, p, F));
        }
        static fromHex(t) {
          return k.fromBytes((0, s.qj)("ristrettoHex", t, 32));
        }
        static msm(t, e) {
          return (0, o.Xf)(k, B.Point.Fn, t, e);
        }
        toBytes() {
          let t,
            e,
            ...
            E =
              ((t = y + g),
              (r = x.create(t) * ((e = y - g), x.create(e))),
              x.create(r)),
            B = ((i = m * g), x.create(i)),
            { value: _ } =
              ((o = E * ((n = B * B), x.create(n))), M(p, x.create(o))),
            S = ((s = _ * E), x.create(s)),
            I = ((h = _ * B), x.create(h)),
            O = ((u = S * I * w), x.create(u));
          if ((0, f.dQ)(w * O, v)) {
            let t,
              e,
              r = ((t = g * b), x.create(t)),
              i = ((e = m * b), x.create(e));
            ((m = r), (g = i), (d = x.create(S * A)));
          } else d = I;
          (0, f.dQ)(m * O, v) && ((a = -g), (g = x.create(a)));
          let R = ((l = (y - g) * d), x.create(l));
          return (
            (0, f.dQ)(R, v) && ((c = -R), (R = x.create(c))),
            x.toBytes(R)
          );
        }
        equals(t) {
          ...
          let { X: o, Y: s } = this.ep,
            { X: f, Y: h } = t.ep,
            u = ((e = o * h), x.create(e) === ((r = s * f), x.create(r))),
            a = ((i = s * h), x.create(i) === ((n = o * f), x.create(n)));
          return u || a;
        }
        is0() {
      ...
      ((k.BASE = new k(B.Point.BASE)),
        (k.ZERO = new k(B.Point.ZERO)),
        (k.Fp = x),
        (k.Fn = E));
    },
    74529: (t, e, r) => {
    ...
    80642: (t, e, r) => {
      ...
      function d({ children: t, isPresent: e, anchorX: r, root: o }) {
        let s = (0, n.useId)(),
          f = (0, n.useRef)(null),
          h = (0, n.useRef)({ width: 0, height: 0, top: 0, left: 0, right: 0 }),
          { nonce: u } = (0, n.useContext)(a.Q),
          d = (function (...t) {
        ...
        return (
          (0, n.useInsertionEffect)(() => {
            let { width: t, height: i, top: n, left: a, right: l } = h.current;
            if (e || !f.current || !t || !i) return;
            let c = "left" === r ? `left: ${a}` : `right: ${l}`;
        ...
        `),
          ...
          (0, i.jsx)(c, {
            ...
            childRef: f,
            sizeRef: h,
            children: n.cloneElement(t, { ref: d }),
          })
        );
      }
      let p = ({
        ...
        return (
          ...
          (0, i.jsx)(h.t.Provider, { value: v, children: t })
        );
      };
      function m() {
        return new Map();
      ...
      let w = ({
        ...
        (0, f.E)(() => {
          ...
          for (let t = 0; t < S.length; t++) {
            let e = y(S[t]);
            M.includes(e) ? B.delete(e) : !0 !== B.get(e) && B.set(e, !1);
          }
        }, [S, M.length, M.join("-")]);
        let O = [];
        if (b !== _) {
          ...
          for (let e = 0; e < S.length; e++) {
            let r = S[e],
              i = y(r);
            M.includes(i) || (t.splice(e, 0, r), O.push(r));
          }
          return ("wait" === a && O.length && (t = O), I(v(t)), A(b), null);
        }
        let { forceRender: R } = (0, n.useContext)(o.L);
        return (0, i.jsx)(i.Fragment, {
          children: S.map((t) => {
            let n = y(t),
              o = (!l || !!m) && (b === S || M.includes(n));
            return (0, i.jsx)(
              p,
              {
                isPresent: o,
                initial: (!x.current || !!r) && void 0,
                custom: e,
                presenceAffectsLayout: u,
                mode: a,
                root: d,
          ...
          for (
            isNaN((e = Math.abs(e))) || e === 1 / 0
              ...
              : ((s = Math.floor(Math.log(e) / Math.LN2)),
                ...
                s + l >= 1 ? (e += c / h) : (e += c * Math.pow(2, 1 - l)),
                e * h >= 2 && (s++, (h /= 2)),
                s + l >= a
                  ? ((f = 0), (s = a))
                  : s + l >= 1
                    ? ((f = (e * h - 1) * Math.pow(2, n)), (s += l))
                    : ((f = e * Math.pow(2, l - 1) * Math.pow(2, n)), (s = 0)));
            n >= 8;
            t[r + d] = 255 & f, d += p, f /= 256, n -= 8
          );
          for (
            s = (s << n) | f, u += n;
            u > 0;
    ...
    85146: (t, e, r) => {
      ...
      let f = (0, i.createContext)(o);
      function h() {
        return (0, i.useContext)(f);
      }
    },
    92602: function (t, e, r) {
      !(function (t, e) {
        "use strict";
        function i(t, e) {
        ...
        function h(t, e, r, n) {
          for (var o = 0, s = 0, f = Math.min(t.length, r), h = e; h < f; h++) {
        ...
        if (
          ...
          (o.prototype._parseBase = function (t, e, r) {
            ...
            if (0 !== s) {
              var l = 1;
              for (u = h(t, a, t.length, e), a = 0; a < s; a++) l *= e;
              (this.imuln(l),
                this.words[0] + u < 0x4000000
                  ? (this.words[0] += u)
                  : this._iaddn(u));
          ...
          try {
            o.prototype[Symbol.for("nodejs.util.inspect.custom")] = a;
          } catch (t) {
            o.prototype.inspect = a;
          }
        else o.prototype.inspect = a;
        function a() {
        ...
        ((o.prototype.toString = function (t, e) {
          ...
          if (t === (0 | t) && t >= 2 && t <= 36) {
            ...
            for (l.negative = 0; !l.isZero(); ) {
              ...
              r = (l = l.idivn(a)).isZero() ? m + r : c[u - m.length] + m + r;
            }
        ...
        var g = function (t, e, r) {
          ...
          var tg =
            (((u + i) | 0) +
              ((8191 & (n = ((n = Math.imul(l, Z)) + Math.imul(c, F)) | 0)) <<
                13)) |
            0;
          ((u = ((((o = Math.imul(c, Z)) + (n >>> 13)) | 0) + (tg >>> 26)) | 0),
            (tg &= 0x3ffffff),
            (i = Math.imul(p, F)),
            (n = ((n = Math.imul(p, Z)) + Math.imul(m, F)) | 0),
            (o = Math.imul(m, Z)),
            (i = (i + Math.imul(l, $)) | 0));
          var ty =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(l, D)) | 0) + Math.imul(c, $)) | 0)) <<
                13)) |
            0;
          ((u =
            ((((o = (o + Math.imul(c, D)) | 0) + (n >>> 13)) | 0) +
              (ty >>> 26)) |
            0),
            (ty &= 0x3ffffff),
            (i = Math.imul(y, F)),
            (n = ((n = Math.imul(y, Z)) + Math.imul(v, F)) | 0),
            (o = Math.imul(v, Z)),
            (i = (i + Math.imul(p, $)) | 0),
            (n = ((n = (n + Math.imul(p, D)) | 0) + Math.imul(m, $)) | 0),
            (o = (o + Math.imul(m, D)) | 0),
            (i = (i + Math.imul(l, Y)) | 0));
          var tv =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(l, K)) | 0) + Math.imul(c, Y)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tv &= 0x3ffffff),
            (i = Math.imul(b, F)),
            (n = ((n = Math.imul(b, Z)) + Math.imul(M, F)) | 0),
            (o = Math.imul(M, Z)),
            (i = (i + Math.imul(y, $)) | 0),
            (n = ((n = (n + Math.imul(y, D)) | 0) + Math.imul(v, $)) | 0),
            (o = (o + Math.imul(v, D)) | 0),
            (i = (i + Math.imul(p, Y)) | 0),
            (n = ((n = (n + Math.imul(p, K)) | 0) + Math.imul(m, Y)) | 0),
            (o = (o + Math.imul(m, K)) | 0),
            (i = (i + Math.imul(l, X)) | 0));
          var tw =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(l, W)) | 0) + Math.imul(c, X)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tw &= 0x3ffffff),
            (i = Math.imul(E, F)),
            (n = ((n = Math.imul(E, Z)) + Math.imul(B, F)) | 0),
            (o = Math.imul(B, Z)),
            (i = (i + Math.imul(b, $)) | 0),
            (n = ((n = (n + Math.imul(b, D)) | 0) + Math.imul(M, $)) | 0),
            (o = (o + Math.imul(M, D)) | 0),
            (i = (i + Math.imul(y, Y)) | 0),
            (n = ((n = (n + Math.imul(y, K)) | 0) + Math.imul(v, Y)) | 0),
            (o = (o + Math.imul(v, K)) | 0),
            (i = (i + Math.imul(p, X)) | 0),
            (n = ((n = (n + Math.imul(p, W)) | 0) + Math.imul(m, X)) | 0),
            (o = (o + Math.imul(m, W)) | 0),
            (i = (i + Math.imul(l, J)) | 0));
          var tb =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(l, tt)) | 0) + Math.imul(c, J)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tb &= 0x3ffffff),
            (i = Math.imul(A, F)),
            (n = ((n = Math.imul(A, Z)) + Math.imul(S, F)) | 0),
            (o = Math.imul(S, Z)),
            (i = (i + Math.imul(E, $)) | 0),
            (n = ((n = (n + Math.imul(E, D)) | 0) + Math.imul(B, $)) | 0),
            (o = (o + Math.imul(B, D)) | 0),
            (i = (i + Math.imul(b, Y)) | 0),
            (n = ((n = (n + Math.imul(b, K)) | 0) + Math.imul(M, Y)) | 0),
            (o = (o + Math.imul(M, K)) | 0),
            (i = (i + Math.imul(y, X)) | 0),
            (n = ((n = (n + Math.imul(y, W)) | 0) + Math.imul(v, X)) | 0),
            (o = (o + Math.imul(v, W)) | 0),
            (i = (i + Math.imul(p, J)) | 0),
            (n = ((n = (n + Math.imul(p, tt)) | 0) + Math.imul(m, J)) | 0),
          ...
          ((u =
            ...
            (tM &= 0x3ffffff),
            (i = Math.imul(O, F)),
            (n = ((n = Math.imul(O, Z)) + Math.imul(R, F)) | 0),
            (o = Math.imul(R, Z)),
            (i = (i + Math.imul(A, $)) | 0),
            (n = ((n = (n + Math.imul(A, D)) | 0) + Math.imul(S, $)) | 0),
            (o = (o + Math.imul(S, D)) | 0),
            (i = (i + Math.imul(E, Y)) | 0),
            (n = ((n = (n + Math.imul(E, K)) | 0) + Math.imul(B, Y)) | 0),
            (o = (o + Math.imul(B, K)) | 0),
            (i = (i + Math.imul(b, X)) | 0),
            (n = ((n = (n + Math.imul(b, W)) | 0) + Math.imul(M, X)) | 0),
            (o = (o + Math.imul(M, W)) | 0),
            (i = (i + Math.imul(y, J)) | 0),
            (n = ((n = (n + Math.imul(y, tt)) | 0) + Math.imul(v, J)) | 0),
          ...
          ((u =
            ...
            (tx &= 0x3ffffff),
            (i = Math.imul(k, F)),
            (n = ((n = Math.imul(k, Z)) + Math.imul(T, F)) | 0),
            (o = Math.imul(T, Z)),
            (i = (i + Math.imul(O, $)) | 0),
            (n = ((n = (n + Math.imul(O, D)) | 0) + Math.imul(R, $)) | 0),
            (o = (o + Math.imul(R, D)) | 0),
            (i = (i + Math.imul(A, Y)) | 0),
            (n = ((n = (n + Math.imul(A, K)) | 0) + Math.imul(S, Y)) | 0),
            (o = (o + Math.imul(S, K)) | 0),
            (i = (i + Math.imul(E, X)) | 0),
            (n = ((n = (n + Math.imul(E, W)) | 0) + Math.imul(B, X)) | 0),
            (o = (o + Math.imul(B, W)) | 0),
            (i = (i + Math.imul(b, J)) | 0),
            (n = ((n = (n + Math.imul(b, tt)) | 0) + Math.imul(M, J)) | 0),
            (o = (o + Math.imul(M, tt)) | 0),
            (i = (i + Math.imul(y, tr)) | 0),
            (n = ((n = (n + Math.imul(y, ti)) | 0) + Math.imul(v, tr)) | 0),
          ...
          var tE =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(l, tu)) | 0) + Math.imul(c, th)) | 0)) <<
                13)) |
            0;
          ((u =
            ((((o = (o + Math.imul(c, tu)) | 0) + (n >>> 13)) | 0) +
              (tE >>> 26)) |
            0),
            (tE &= 0x3ffffff),
            (i = Math.imul(q, F)),
            (n = ((n = Math.imul(q, Z)) + Math.imul(j, F)) | 0),
            (o = Math.imul(j, Z)),
            (i = (i + Math.imul(k, $)) | 0),
            (n = ((n = (n + Math.imul(k, D)) | 0) + Math.imul(T, $)) | 0),
            (o = (o + Math.imul(T, D)) | 0),
            (i = (i + Math.imul(O, Y)) | 0),
            (n = ((n = (n + Math.imul(O, K)) | 0) + Math.imul(R, Y)) | 0),
            (o = (o + Math.imul(R, K)) | 0),
            (i = (i + Math.imul(A, X)) | 0),
            (n = ((n = (n + Math.imul(A, W)) | 0) + Math.imul(S, X)) | 0),
            (o = (o + Math.imul(S, W)) | 0),
            (i = (i + Math.imul(E, J)) | 0),
            (n = ((n = (n + Math.imul(E, tt)) | 0) + Math.imul(B, J)) | 0),
            (o = (o + Math.imul(B, tt)) | 0),
            (i = (i + Math.imul(b, tr)) | 0),
            (n = ((n = (n + Math.imul(b, ti)) | 0) + Math.imul(M, tr)) | 0),
            (o = (o + Math.imul(M, ti)) | 0),
            (i = (i + Math.imul(y, to)) | 0),
            (n = ((n = (n + Math.imul(y, ts)) | 0) + Math.imul(v, to)) | 0),
          ...
          ((u =
            ...
            (tB &= 0x3ffffff),
            (i = Math.imul(z, F)),
            (n = ((n = Math.imul(z, Z)) + Math.imul(N, F)) | 0),
            (o = Math.imul(N, Z)),
            (i = (i + Math.imul(q, $)) | 0),
            (n = ((n = (n + Math.imul(q, D)) | 0) + Math.imul(j, $)) | 0),
            (o = (o + Math.imul(j, D)) | 0),
            (i = (i + Math.imul(k, Y)) | 0),
            (n = ((n = (n + Math.imul(k, K)) | 0) + Math.imul(T, Y)) | 0),
            (o = (o + Math.imul(T, K)) | 0),
            (i = (i + Math.imul(O, X)) | 0),
            (n = ((n = (n + Math.imul(O, W)) | 0) + Math.imul(R, X)) | 0),
            (o = (o + Math.imul(R, W)) | 0),
            (i = (i + Math.imul(A, J)) | 0),
            (n = ((n = (n + Math.imul(A, tt)) | 0) + Math.imul(S, J)) | 0),
            ...
            (n = ((n = (n + Math.imul(y, tu)) | 0) + Math.imul(v, th)) | 0),
          ...
          ((u =
            ...
            (t_ &= 0x3ffffff),
            (i = Math.imul(z, $)),
            (n = ((n = Math.imul(z, D)) + Math.imul(N, $)) | 0),
            (o = Math.imul(N, D)),
            (i = (i + Math.imul(q, Y)) | 0),
            (n = ((n = (n + Math.imul(q, K)) | 0) + Math.imul(j, Y)) | 0),
            (o = (o + Math.imul(j, K)) | 0),
            (i = (i + Math.imul(k, X)) | 0),
            (n = ((n = (n + Math.imul(k, W)) | 0) + Math.imul(T, X)) | 0),
            (o = (o + Math.imul(T, W)) | 0),
            (i = (i + Math.imul(O, J)) | 0),
            (n = ((n = (n + Math.imul(O, tt)) | 0) + Math.imul(R, J)) | 0),
            (o = (o + Math.imul(R, tt)) | 0),
            (i = (i + Math.imul(A, tr)) | 0),
            (n = ((n = (n + Math.imul(A, ti)) | 0) + Math.imul(S, tr)) | 0),
            ...
            (n = ((n = (n + Math.imul(y, tc)) | 0) + Math.imul(v, tl)) | 0),
          ...
          ((u =
            ...
            (tA &= 0x3ffffff),
            (i = Math.imul(z, Y)),
            (n = ((n = Math.imul(z, K)) + Math.imul(N, Y)) | 0),
            (o = Math.imul(N, K)),
            (i = (i + Math.imul(q, X)) | 0),
            (n = ((n = (n + Math.imul(q, W)) | 0) + Math.imul(j, X)) | 0),
            (o = (o + Math.imul(j, W)) | 0),
            (i = (i + Math.imul(k, J)) | 0),
            (n = ((n = (n + Math.imul(k, tt)) | 0) + Math.imul(T, J)) | 0),
            (o = (o + Math.imul(T, tt)) | 0),
            (i = (i + Math.imul(O, tr)) | 0),
            (n = ((n = (n + Math.imul(O, ti)) | 0) + Math.imul(R, tr)) | 0),
            ...
            (n = ((n = (n + Math.imul(b, tc)) | 0) + Math.imul(M, tl)) | 0),
            (o = (o + Math.imul(M, tc)) | 0),
          ...
          var tS =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(y, tm)) | 0) + Math.imul(v, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tS &= 0x3ffffff),
            (i = Math.imul(z, X)),
            (n = ((n = Math.imul(z, W)) + Math.imul(N, X)) | 0),
            (o = Math.imul(N, W)),
            (i = (i + Math.imul(q, J)) | 0),
            (n = ((n = (n + Math.imul(q, tt)) | 0) + Math.imul(j, J)) | 0),
            (o = (o + Math.imul(j, tt)) | 0),
            (i = (i + Math.imul(k, tr)) | 0),
            (n = ((n = (n + Math.imul(k, ti)) | 0) + Math.imul(T, tr)) | 0),
            (o = (o + Math.imul(T, ti)) | 0),
            (i = (i + Math.imul(O, to)) | 0),
            (n = ((n = (n + Math.imul(O, ts)) | 0) + Math.imul(R, to)) | 0),
            (o = (o + Math.imul(R, ts)) | 0),
            (i = (i + Math.imul(A, th)) | 0),
            (n = ((n = (n + Math.imul(A, tu)) | 0) + Math.imul(S, th)) | 0),
            (o = (o + Math.imul(S, tu)) | 0),
            (i = (i + Math.imul(E, tl)) | 0),
            (n = ((n = (n + Math.imul(E, tc)) | 0) + Math.imul(B, tl)) | 0),
          ...
          var tI =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(b, tm)) | 0) + Math.imul(M, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ((((o = (o + Math.imul(M, tm)) | 0) + (n >>> 13)) | 0) +
            ...
            (tI &= 0x3ffffff),
            (i = Math.imul(z, J)),
            (n = ((n = Math.imul(z, tt)) + Math.imul(N, J)) | 0),
            (o = Math.imul(N, tt)),
            (i = (i + Math.imul(q, tr)) | 0),
            (n = ((n = (n + Math.imul(q, ti)) | 0) + Math.imul(j, tr)) | 0),
            (o = (o + Math.imul(j, ti)) | 0),
            (i = (i + Math.imul(k, to)) | 0),
            (n = ((n = (n + Math.imul(k, ts)) | 0) + Math.imul(T, to)) | 0),
            (o = (o + Math.imul(T, ts)) | 0),
            (i = (i + Math.imul(O, th)) | 0),
            (n = ((n = (n + Math.imul(O, tu)) | 0) + Math.imul(R, th)) | 0),
            (o = (o + Math.imul(R, tu)) | 0),
            (i = (i + Math.imul(A, tl)) | 0),
            (n = ((n = (n + Math.imul(A, tc)) | 0) + Math.imul(S, tl)) | 0),
          ...
          var tO =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(E, tm)) | 0) + Math.imul(B, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tO &= 0x3ffffff),
            (i = Math.imul(z, tr)),
            (n = ((n = Math.imul(z, ti)) + Math.imul(N, tr)) | 0),
            (o = Math.imul(N, ti)),
            (i = (i + Math.imul(q, to)) | 0),
            (n = ((n = (n + Math.imul(q, ts)) | 0) + Math.imul(j, to)) | 0),
            (o = (o + Math.imul(j, ts)) | 0),
            (i = (i + Math.imul(k, th)) | 0),
            (n = ((n = (n + Math.imul(k, tu)) | 0) + Math.imul(T, th)) | 0),
            (o = (o + Math.imul(T, tu)) | 0),
            (i = (i + Math.imul(O, tl)) | 0),
            (n = ((n = (n + Math.imul(O, tc)) | 0) + Math.imul(R, tl)) | 0),
          ...
          var tR =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(A, tm)) | 0) + Math.imul(S, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tR &= 0x3ffffff),
            (i = Math.imul(z, to)),
            (n = ((n = Math.imul(z, ts)) + Math.imul(N, to)) | 0),
            (o = Math.imul(N, ts)),
            (i = (i + Math.imul(q, th)) | 0),
            (n = ((n = (n + Math.imul(q, tu)) | 0) + Math.imul(j, th)) | 0),
            (o = (o + Math.imul(j, tu)) | 0),
            (i = (i + Math.imul(k, tl)) | 0),
            (n = ((n = (n + Math.imul(k, tc)) | 0) + Math.imul(T, tl)) | 0),
          ...
          var tU =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(O, tm)) | 0) + Math.imul(R, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ((((o = (o + Math.imul(R, tm)) | 0) + (n >>> 13)) | 0) +
              (tU >>> 26)) |
            0),
            (tU &= 0x3ffffff),
            (i = Math.imul(z, th)),
            (n = ((n = Math.imul(z, tu)) + Math.imul(N, th)) | 0),
            (o = Math.imul(N, tu)),
            (i = (i + Math.imul(q, tl)) | 0),
            (n = ((n = (n + Math.imul(q, tc)) | 0) + Math.imul(j, tl)) | 0),
            (o = (o + Math.imul(j, tc)) | 0),
            (i = (i + Math.imul(k, tp)) | 0));
          var tk =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(k, tm)) | 0) + Math.imul(T, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ...
            (tk &= 0x3ffffff),
            (i = Math.imul(z, tl)),
            (n = ((n = Math.imul(z, tc)) + Math.imul(N, tl)) | 0),
            (o = Math.imul(N, tc)),
            (i = (i + Math.imul(q, tp)) | 0));
          var tT =
            (((u + i) | 0) +
              ((8191 &
                (n =
                  ((n = (n + Math.imul(q, tm)) | 0) + Math.imul(j, tp)) | 0)) <<
                13)) |
            0;
          ((u =
            ((((o = (o + Math.imul(j, tm)) | 0) + (n >>> 13)) | 0) +
              (tT >>> 26)) |
            0),
            (tT &= 0x3ffffff),
            (i = Math.imul(z, tp)));
          var tL =
            (((u + i) | 0) +
              ((8191 & (n = ((n = Math.imul(z, tm)) + Math.imul(N, tp)) | 0)) <<
                13)) |
            0;
          return (
            (u =
              ((((o = Math.imul(N, tm)) + (n >>> 13)) | 0) + (tL >>> 26)) | 0),
            (tL &= 0x3ffffff),
            (h[0] = tg),
            (h[1] = ty),
            (h[2] = tv),
        ...
        (Math.imul || (g = m),
          ...
          (v.prototype.mulp = function (t, e, r) {
            ...
            for (var d = 0; d < i; d++) {
              var p = f[d] * a[d] - h[d] * l[d];
              ((h[d] = f[d] * l[d] + h[d] * a[d]), (f[d] = p));
            }
            return (
              this.conjugate(f, h, i),
              this.transform(f, h, c, o, i, n),
                ...
                : 0 === this.negative && 0 !== t.negative
                  ...
                  : (this.negative & t.negative) != 0
                    ? ((f = this.neg().divmod(t.neg(), e)),
                      "div" !== e &&
                        ((s = f.mod.neg()), r && 0 !== s.negative && s.isub(t)),
                      { div: f.div, mod: s })
          ...
          (o.prototype.egcd = function (t) {
            ...
            for (
              var n = new o(1), s = new o(0), f = new o(0), h = new o(1), u = 0;
              e.isEven() && r.isEven();

            )
              (e.iushrn(1), r.iushrn(1), ++u);
            for (var a = r.clone(), l = e.clone(); !e.isZero(); ) {
              for (
                var c = 0, d = 1;
                (e.words[0] & d) == 0 && c < 26;
                ++c, d <<= 1
          ...
          (o.prototype._invmp = function (t) {
            ...
            for (
              var s = new o(1), f = new o(0), h = n.clone();
              ...
              r.cmp(n) >= 0 ? (r.isub(n), s.isub(f)) : (n.isub(r), f.isub(s));
            }
            return (0 > (e = 0 === r.cmpn(1) ? s : f).cmpn(0) && e.iadd(t), e);
          }),
          ...
          (o.prototype.bincn = function (t) {
            ...
            for (var o = n, s = r; 0 !== o && s < this.length; s++) {
              ...
              ((f += o), (o = f >>> 26), (f &= 0x3ffffff), (this.words[s] = f));
            }
        ...
        ((b.prototype._tmp = function () {
          ...
          (_.prototype.sqrt = function (t) {
            ...
            for (
              ...
              for (var m = d, g = 0; 0 !== m.cmp(f); g++) m = m.redSqr();
              i(g < p);
              var y = this.pow(l, new o(1).iushln(p - g - 1));
              ((c = c.redMul(y)), (l = y.redSqr()), (d = d.redMul(l)), (p = g));
            }
            return c;
          }),
    ...
    95042: (t, e, r) => {
      ...
      let o = BigInt(0),
        ...
        c = [],
        d = [];
      for (let t = 0, e = s, r = 1, i = 0; t < 24; t++) {
        (([r, i] = [i, (2 * r + 3 * i) % 5]),
          l.push(2 * (5 * i + r)),
          c.push((((t + 1) * (t + 2)) / 2) % 64));
        let n = o;
      ...
      let p = (0, i.lD)(d, !0),
        ...
        v = (t, e, r) => (r > 32 ? (0, i.im)(t, e, r) : (0, i.B4)(t, e, r));
      class w extends n.Vw {
        ...
        update(t) {
          ((0, n.CC)(this), (t = (0, n.ZJ)(t)), (0, n.DO)(t));
        ...
        writeInto(t) {
          ((0, n.CC)(this, !1), (0, n.DO)(t), this.finish());
          let e = this.state,
            { blockLen: r } = this;
        ...
        xof(t) {
          return ((0, n.Fe)(t), this.xofInto(new Uint8Array(t)));
        }
        digestInto(t) {
          if (((0, n.Ht)(t, this), this.finished))
      ...
      let b = (0, n.qj)(() => new w(136, 1, 32));
    },
    96697: function (t, e, r) {
      !(function (t, e) {
        "use strict";
        function i(t, e) {
          if (!t) throw Error(e || "Assertion failed");
    ...
    98120: (t, e, r) => {
      ...
      class i extends TypeError {
        constructor(t, e) {
          let r;
          const { message: i, explanation: n, ...o } = t,
            { path: s } = t,
            f = 0 === s.length ? i : `At path: ${s.join(".")} -- ${i}`;
          (super(n ?? f),
            null != n && (this.cause = f),
          ...
          let t = (function (t, e, r, i) {
            ...
            let { path: n, branch: o } = e,
              { type: f } = r,
              {
                refinement: h,
                message:
                  u = `Expected a value of type \`${f}\`${h ? ` with refinement \`${h}\`` : ""}, but received: \`${s(i)}\``,
              } = t;
            return {
              value: i,
              type: f,
      ...
      function* h(t, e, r = {}) {
        let { path: i = [], branch: o = [t], coerce: s = !1, mask: f = !1 } = r,
          u = { path: i, branch: o, mask: f };
        s && (t = e.coercer(t, u));
        let a = "valid";
        for (let i of e.validator(t, u))
          ((i.explanation = r.message), (a = "not_valid"), yield [i, void 0]);
        for (let [l, c, d] of e.entries(t, u))
          for (let e of h(c, d, {
            path: void 0 === l ? i : [...i, l],
            ...
            e[0]
              ? ((a = null != e[0].refinement ? "not_refined" : "not_valid"),
                yield [e[0], void 0])
              : s &&
                ((c = e[1]),
                void 0 === l
        ...
        if ("not_valid" !== a)
          for (let i of e.refiner(t, u))
            ((i.explanation = r.message),
              (a = "not_refined"),
              yield [i, void 0]);
        "valid" === a && (yield [void 0, t]);
      }
      class u {
        constructor(t) {
          const {
          ...
          ((this.type = e),
            ...
            (this.coercer = o),
            i
              ? (this.validator = (t, e) => f(i(t, e), e, this, t))
              : (this.validator = () => []),
            n
              ? (this.refiner = (t, e) => f(n(t, e), e, this, t))
              : (this.refiner = () => []));
        }
        assert(t, e) {
          var r = t,
        ...
        is(t) {
          var e, r;
          return ((e = t), (r = this), !l(e, r)[0]);
        }
        mask(t, e) {
          var r = t,
            i = this,
            n = e;
          let o = l(r, i, { coerce: !0, mask: !0, message: n });
          if (!o[0]) return o[1];
          throw o[0];
        }
        validate(t, e = {}) {
      ...
      function _(t) {
        ...
        return new u({
          ...
          validator(r, i) {
            ...
            return [
              `Expected the value to satisfy a union of \`${e}\`, but received: ${s(r)}`,
              ...n,
            ];
          },
        });
